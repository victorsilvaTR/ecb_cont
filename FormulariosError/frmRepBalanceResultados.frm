...
Begin VB.Form frmRepBalanceResultados 
   ...
   ClientTop       =   2100
   ClientWidth     =   7605
   Icon            =   "frmRepBalanceResultados.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3900
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.Image Image2 
            Height          =   1275
            Left            =   0
            Picture         =   "frmRepBalanceResultados.frx":1982
            Top             =   -240
            Width           =   1740
         End
      End
   ...
   Begin TrueOleDBList70.TDBCombo tdbcMes 
      ...
      AddItemSeparator=   ";"
      _PropDict       =   $"frmRepBalanceResultados.frx":2562
   ...
   Begin TrueOleDBList70.TDBCombo tdbcMoneda 
      ...
      RowSubDividerColor=   12632256
      AddItemSeparator=   ";"
      _PropDict       =   $"frmRepBalanceResultados.frx":25E9
      _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
      _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
      _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
      _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin MSForms.CommandButton cmdSalir 
      ...
      Size            =   "2937;767"
      Picture         =   "frmRepBalanceResultados.frx":2670
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton cmdImprimir 
      ...
      PicturePosition =   327683
      Size            =   "2937;767"
      Picture         =   "frmRepBalanceResultados.frx":2C0A
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepBalanceResultados"
...
Private Sub cmdImprimir_Click()
    ...
    If optAcumulado.Value = True Then
        formulas(0) = "tipo = 'ACUMULADO'"
    Else
        formulas(0) = "tipo = 'DELMES'"
    End If

    

    AbreReporteParam gsDSN, Me, rutaReportes & "RptBalanceGeneral.rpt", crptToWindow, Titulo, "", matriz_fecha(), formulas()
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmRepBalanceResultados = Nothing
End Sub

Private Sub optAcumulado_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    pSetFocus tdbcMes
End If
End Sub
...
Private Sub optDelmes_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    pSetFocus tdbcMes
End If
End Sub
