...
Begin VB.Form frmRepSaldosNetos 
   ...
   ClientTop       =   450
   ClientWidth     =   7065
   Icon            =   "frmRepSaldosNetos.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   4410
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepSaldosNetos.frx":0ECA
      ...
      Begin TDBText6Ctl.TDBText tdbnDigitos 
         ...
         _ExtentX        =   1005
         _ExtentY        =   556
         Caption         =   "frmRepSaldosNetos.frx":0F51
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmRepSaldosNetos.frx":0FBD
         Key             =   "frmRepSaldosNetos.frx":0FDB
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TDBText6Ctl.TDBText TDBInicio 
            ...
            _ExtentX        =   2275
            _ExtentY        =   556
            Caption         =   "frmRepSaldosNetos.frx":102D
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosNetos.frx":1099
            Key             =   "frmRepSaldosNetos.frx":10B7
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   0
         ...
         Begin TDBText6Ctl.TDBText tdbtDescripcionDesde 
            ...
            _ExtentX        =   7223
            _ExtentY        =   556
            Caption         =   "frmRepSaldosNetos.frx":1109
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosNetos.frx":1175
            Key             =   "frmRepSaldosNetos.frx":1193
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   1
         ...
         Begin TDBText6Ctl.TDBText TDBFinal 
            ...
            _ExtentX        =   2275
            _ExtentY        =   556
            Caption         =   "frmRepSaldosNetos.frx":11E5
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosNetos.frx":1251
            Key             =   "frmRepSaldosNetos.frx":126F
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   0
         ...
         Begin TDBText6Ctl.TDBText tdbtDescripcionHasta 
            ...
            _ExtentX        =   7223
            _ExtentY        =   556
            Caption         =   "frmRepSaldosNetos.frx":12C1
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosNetos.frx":132D
            Key             =   "frmRepSaldosNetos.frx":134B
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   1
      ...
      Begin TrueOleDBList70.TDBCombo tdbcDelMes 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepSaldosNetos.frx":138F
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList70.TDBCombo tdbcAlMes 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepSaldosNetos.frx":1416
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdImprimir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmRepSaldosNetos.frx":149D
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepSaldosNetos"
...
Private Function Validacion() As Boolean
    ...
    If CE(TDBInicio) = "" And chkCuentas.Value = vbChecked Then
    ...
    If CE(TDBFinal) = "" And chkCuentas.Value = vbChecked Then
    ...
    If CE(TDBFinal) < CE(TDBInicio) And chkCuentas.Value = vbChecked Then
...
Private Sub cmdImprimir_Click()
    ...
    matriz_fecha(3) = "@Ase_cUserCrea;" & gsUsuario & ";True"
    matriz_fecha(4) = "@CuentaIni;" & TDBInicio & ";True"
    matriz_fecha(5) = "@CuentaFin;" & TDBFinal & ";True"
    matriz_fecha(6) = "@Digitos;" & tdbnDigitos & ";True"
    ' *** Verificando Digitos
    ...
    formulas(0) = "digitos = " & tdbnDigitos.Text
    AbreReporteParam gsDSN, Me, rutaReportes & "RptSaldosMensuales.rpt", crptToWindow, "Analisis de Cuentas", "", matriz_fecha(), formulas()
...
Private Sub TDBFinal_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 112 Then
        Call LlamaBuscar(frmBuscador, Me.TDBFinal.Name, Control, "CuentasND", Me, gsPeriodo, Me.TDBFinal.Text)
    End If
End Sub
...
Private Sub TDBInicio_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 112 Then
        Call LlamaBuscar(frmBuscador, Me.TDBInicio.Name, Control, "CuentasND", Me, gsPeriodo, Me.TDBInicio.Text)
    End If
End Sub
...
Private Sub tdbnDigitos_Change()
    ...
    TDBInicio.MaxLength = Val(tdbnDigitos.Text)
    TDBFinal.MaxLength = Val(tdbnDigitos.Text)
