...
Begin VB.Form frmPrcRegistroCoaImp 
   ...
   Begin TDBDate6Ctl.TDBDate TDBDate1 
      ...
      _ExtentX        =   2355
      _ExtentY        =   529
      Calendar        =   "frmPDBCompras.frx":1982
      Caption         =   "frmPDBCompras.frx":1A84
      ...
      EndProperty
      DropDown        =   "frmPDBCompras.frx":1AE8
      Keys            =   "frmPDBCompras.frx":1B06
      Spin            =   "frmPDBCompras.frx":1B72
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   16777215
   ...
   Begin TDBNumber6Ctl.TDBNumber TDBNumber1 
      ...
      _ExtentX        =   1931
      _ExtentY        =   661
      Calculator      =   "frmPDBCompras.frx":1B9A
      Caption         =   "frmPDBCompras.frx":1BBA
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmPDBCompras.frx":1C26
      Keys            =   "frmPDBCompras.frx":1C44
      Spin            =   "frmPDBCompras.frx":1C8E
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   16777215
   ...
   Begin TrueOleDBList70.TDBCombo tdbcMes 
      ...
      AddItemSeparator=   ";"
      _PropDict       =   $"frmPDBCompras.frx":1CB6
      _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
      _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
      _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
   ...
   Begin TrueOleDBList70.TDBCombo tdbcLibro 
      ...
      RowSubDividerColor=   12632256
      AddItemSeparator=   ";"
      _PropDict       =   $"frmPDBCompras.frx":1D3D
      _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
      _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
      _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
      _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin MSForms.CommandButton cmdSalir 
      ...
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":1DC4
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton cmdTodos 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":235E
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdGrabar 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":28F8
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdEliminarTodo 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":2E92
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdEliminaItem 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":342C
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdInsertarItem 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":39C6
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdListar 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmPDBCompras.frx":3F60
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
