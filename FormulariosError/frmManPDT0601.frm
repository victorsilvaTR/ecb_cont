...
Begin VB.Form frmManPDT0601 
   ...
   Begin TrueOleDBGrid70.TDBGrid tdbgPDT0601 
      ...
      Splits(0)._ColumnProps(57)=   "Column(11).Width=2619"
      Splits(0)._ColumnProps(58)=   "Column(11).DividerColor=0"
      Splits(0)._ColumnProps(59)=   "Column(11)._WidthInPix=2540"
      Splits(0)._ColumnProps(60)=   "Column(11)._ColStyle=513"
      Splits(0)._ColumnProps(61)=   "Column(11).Order=12"
      Splits(0)._ColumnProps(62)=   "Column(12).Width=900"
      Splits(0)._ColumnProps(63)=   "Column(12).DividerColor=0"
      Splits(0)._ColumnProps(64)=   "Column(12)._WidthInPix=820"
      Splits(0)._ColumnProps(65)=   "Column(12)._ColStyle=513"
      Splits(0)._ColumnProps(66)=   "Column(12).Order=13"
      Splits(0)._ColumnProps(67)=   "Column(13).Width=1640"
      Splits(0)._ColumnProps(68)=   "Column(13).DividerColor=0"
      Splits(0)._ColumnProps(69)=   "Column(13)._WidthInPix=1561"
      ...
      Splits(0)._ColumnProps(76)=   "Column(14).Visible=0"
...
'PGBV 28102013
    ...
    If tdbgPDT0601.DestinationCol = 11 Then
        For i = 0 To Contador
            If CE(lArrDatos(i, 1)) <> "" Then
                lArrDatos(i, 11) = "x"
            End If
