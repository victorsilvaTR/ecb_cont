...
Begin VB.Form frmRepSaldosCuenta 
   ...
   ClientTop       =   435
   ClientWidth     =   6960
   Icon            =   "frmRepSaldosCuenta.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ScaleHeight     =   3915
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TDBText6Ctl.TDBText TDBInicio 
            ...
            _ExtentX        =   2275
            _ExtentY        =   556
            Caption         =   "frmRepSaldosCuenta.frx":0ECA
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosCuenta.frx":0F36
            Key             =   "frmRepSaldosCuenta.frx":0F54
         ...
         Begin TDBText6Ctl.TDBText tdbtDescripcionDesde 
            ...
            _ExtentX        =   7223
            _ExtentY        =   556
            Caption         =   "frmRepSaldosCuenta.frx":0FA6
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosCuenta.frx":1012
            Key             =   "frmRepSaldosCuenta.frx":1030
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   1
         ...
         Begin TDBText6Ctl.TDBText TDBFinal 
            ...
            _ExtentX        =   2275
            _ExtentY        =   556
            Caption         =   "frmRepSaldosCuenta.frx":1082
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosCuenta.frx":10EE
            Key             =   "frmRepSaldosCuenta.frx":110C
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   0
         ...
         Begin TDBText6Ctl.TDBText tdbtDescripcionHasta 
            ...
            _ExtentX        =   7223
            _ExtentY        =   556
            Caption         =   "frmRepSaldosCuenta.frx":115E
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmRepSaldosCuenta.frx":11CA
            Key             =   "frmRepSaldosCuenta.frx":11E8
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   1
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepSaldosCuenta.frx":122C
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         Size            =   "2937;767"
         Picture         =   "frmRepSaldosCuenta.frx":12B3
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton cmdImprimir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmRepSaldosCuenta.frx":184D
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepSaldosCuenta"
...
Private Sub cmdImprimir_Click()
    ...
    matriz_fecha(2) = "@Per_cPeriodo;" & tdbcMoneda.BoundText & ";True"
    matriz_fecha(3) = "@CuentaInicio;" & TDBInicio & ";True"
    matriz_fecha(4) = "@CuentaFin;" & TDBFinal & ";True"
    
    matriz_fecha(5) = "@CuentaInicio;" & TDBInicio & ";True"
    matriz_fecha(6) = "@CuentaFin;" & TDBFinal & ";True"
    ...
    formulas(0) = "digitos = " & 7
    AbreReporteParam gsDSN, Me, rutaReportes & "RptSaldosCuenta.rpt", crptToWindow, "Reporte de Saldos Mensuales ", "", matriz_fecha(), formulas()
...
Private Sub Form_Load()
    ...
    sqlcombos = "SELECT Mon_cCodigo, Mon_cNombreLargo, Mon_cMNac, Mon_cMExt From CNT_TIPO_MONEDA " & _
                ...
                'LlenaComboMesAddItem tdbcMoneda
    LlenaComboMesApeAddItem tdbcMoneda
                
                
    'LlenarComboAddItem tdbcMoneda, sqlcombos
    'Call BuscarMonedaNacional
    tdbcMoneda.BoundText = gsPeriodo
...
Private Sub TDBFinal_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 112 Then Call LlamaBuscar(frmBuscador, Me.TDBFinal.Name, Control, "Cuentas", Me, gsPeriodo, Me.TDBFinal.Text)
End Sub
...
Private Sub TDBInicio_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 112 Then Call LlamaBuscar(frmBuscador, Me.TDBInicio.Name, Control, "Cuentas", Me, gsPeriodo, Me.TDBInicio.Text)
End Sub
