...
Begin VB.Form frmRepPatrimonioNeto 
   ...
   ClientTop       =   435
   ClientWidth     =   6585
   Icon            =   "frmRepPatrimonioNeto.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   2775
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepPatrimonioNeto.frx":0ECA
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepPatrimonioNeto.frx":0F51
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      End
      Begin MSForms.CommandButton cmdReporte 
         Height          =   435
         Left            =   1560
         TabIndex        =   2
         Top             =   2025
         ...
         Size            =   "2937;767"
         Picture         =   "frmRepPatrimonioNeto.frx":0FD8
         FontHeight      =   165
         FontCharSet     =   0
   ...
   End
End
Attribute VB_Name = "frmRepPatrimonioNeto"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim lArrMnt(13) As Variant
...
Private Sub cmdReporte_Click()
    ...
    If CE(tdbcMes.Text) = "" Then
       Mensajes "Seleccione el periodo inicial"
       pSetFocus tdbcMes
       Exit Sub
    End If
    ...
    AnioAnt = CE(NE(gsAnio) - 1)

    matriz_fecha(0) = "@EMPRESA;" & gsEmpresaNom & ";True"
    matriz_fecha(1) = "@RUC;" & gsRUC & ";True"
    matriz_fecha(2) = "@Tipo;REPORTE;True"
    matriz_fecha(3) = "@Emp_cCodigo;" & gsEmpresa & ";True"
    matriz_fecha(4) = "@Pan_cAnio;" & gsAnio & ";True"
    matriz_fecha(5) = "@Per_cPeriodo;00;True"
    matriz_fecha(6) = "@Per_cPeriodoFin;" & tdbcMes.BoundText & ";True"
    matriz_fecha(7) = "@Mon_cMoneda;" & tdbcMoneda.BoundText & ";True"
    matriz_fecha(8) = "@FechaIni;" & PrimerDiaMes("01", gsAnio) & ";True"
    matriz_fecha(9) = "@FechaFin;" & UltimoDiaMes(tdbcMes.BoundText, gsAnio) & ";True"
    matriz_fecha(10) = "@NOMMONEDA;" & tdbcMoneda.Text & ";True"
        
    Dim formulas(0) As Variant
    AbreReporteParam gsDSN, Me, rutaReportes & "RptFormato_0319.rpt", crptToWindow, "Reporte de Patrimonio Neto", "", matriz_fecha(), formulas()
