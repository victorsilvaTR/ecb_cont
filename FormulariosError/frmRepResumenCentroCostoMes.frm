...
Begin VB.Form frmRepResumenCentroCostoMes 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Resumen de Centro de Costo Anual"
   ClientHeight    =   2655
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7320
   Icon            =   "frmRepResumenCentroCostoMes.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin VB.Frame FraAGRUPADOPOR 
         ...
         Begin VB.OptionButton optCCosto 
            Caption         =   "Por Centro de Costo y Cuenta"
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   9
               Charset         =   0
         ...
         Begin VB.OptionButton optCuenta 
            Caption         =   "Por Cuenta y Centro de Costo"
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   9
               Charset         =   0
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepResumenCentroCostoMes.frx":0ECA
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepResumenCentroCostoMes.frx":0F51
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmRepResumenCentroCostoMes.frx":0FD8
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepResumenCentroCostoMes"
...
Private Sub cmdImprimir_Click()
    ...
    End If
    AbreReporteParam gsDSN, Me, rutaReportes & "RptCentroCostoResumenMes.rpt", crptToWindow, "Reporte por Cuentas y Centro de Costo Mensual", "", matriz_fecha(), formulas()
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmRepResumenCentroCostoMes = Nothing
    Call frmMDIConta.TabForm_CerrarN(NE(Me.hwnd))

End Sub

Private Sub optCCosto_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    pSetFocus tdbcMes
End If
End Sub

Private Sub optCuenta_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
    pSetFocus tdbcMes
End If
End Sub
