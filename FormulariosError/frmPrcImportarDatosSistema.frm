        ...
        If ExisteCtaImp(rsExp("Pla_cCuentaContable").Value) = False Then
            sqlExp = "set dateformat dmy " & vbCrLf & _
                    "INSERT INTO CNM_PLAN_CTA(Emp_cCodigo, Pan_cAnio, Pla_cCuentaContable, Pla_cNombreCuenta, Pla_cTitulo, " & _
                     ...
                     "Pla_dFechaModifica , Pla_cEquipoUser, Pla_cNCND, Pla_cConsPDT, Pla_dEstadoO, Pla_dEstadoD " & _
                     ") VALUES( "
                     '
    ...
    Do While Not rsExp.EOF
        ...
        '    rsExp("Per_cPeriodo").Value, rsExp("Lib_cTipoLibro").Value, Me.tdbcSucursal.BoundText) = False Then
            ...
            sqlExp = "set dateformat dmy " & vbCrLf & _
                     ...
                     "[Ase_cEquipoUser], [Ase_cCuadreManual],[Asd_cEstadoO], [Asd_cEstadoD]) " & _
                     ...
                     "'" & rsExp("Ase_cCuadreManual").Value & "', '" & rsExp("Asd_cEstadoO").Value & "', '" & rsExp("Asd_cEstadoD").Value & "') "
...
''    clsMante.BeginTrans
    Do While Not rsExp.EOF
        ...
        "ECP_COPERACION, Asd_cRegAux, Asd_cConvMon, Asd_cManual , Asd_cRegAuxDet , Asd_cGrupo ) " & _
        "Values " & _
        ...
        "'" & CE(lArrCab(49)) & "','" & CE(lArrCab(50)) & "','" & CE(lArrCab(51)) & "','" & CE(lArrCab(52)) & "','" & CE(lArrCab(53)) & "' , '' )"
    ...
    Select Case tabla
        ...
        Case "CEntidades3":
            sql = "INSERT INTO CNM_ENTIDAD( " & _
                  ...
                  "Ent_cUserCrea, Ent_dFechaCrea, Ent_cUserModifica, Ent_dFechaModifica, Ent_cEquipoUser) VALUES("
        ...
        Case "CParam":
            sql = "INSERT INTO CNT_CONFIG_LIBROS(" & _
                  ...
                  "Cfl_cUserCrea, Cfl_dFechaCrea, Cfl_cUserModifica, Cfl_dFechaModifica, Cfl_cEquipoUser, Pan_cAnio) VALUES("
