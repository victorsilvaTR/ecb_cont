...
Begin VB.Form FrmRegPer_Ret 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"FrmRegPer_Ret.frx":0ECA
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"FrmRegPer_Ret.frx":0F51
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         Size            =   "2937;767"
         Picture         =   "FrmRegPer_Ret.frx":0FD8
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton cmdImprimir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "FrmRegPer_Ret.frx":1572
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   Begin TDBDate6Ctl.TDBDate dtpDesde 
      ...
      _ExtentX        =   3413
      _ExtentY        =   529
      Calendar        =   "FrmRegPer_Ret.frx":1B0C
      Caption         =   "FrmRegPer_Ret.frx":1C0E
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "FrmRegPer_Ret.frx":1C72
      Keys            =   "FrmRegPer_Ret.frx":1C90
      Spin            =   "FrmRegPer_Ret.frx":1CFC
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   1
   ...
   Begin TDBDate6Ctl.TDBDate dtpHasta 
      ...
      _ExtentX        =   3413
      _ExtentY        =   529
      Calendar        =   "FrmRegPer_Ret.frx":1D24
      Caption         =   "FrmRegPer_Ret.frx":1E26
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "FrmRegPer_Ret.frx":1E8A
      Keys            =   "FrmRegPer_Ret.frx":1EA8
      Spin            =   "FrmRegPer_Ret.frx":1F14
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   1
      BackColor       =   -2147483643
   ...
   End
End
Attribute VB_Name = "FrmRegPer_Ret"
...
Private Sub cmdImprimir_Click()
    ...
    If Me.optCompras.Value = True Then
        ...
        AbreReporteParam gsDSN, Me, rutaReportes & "RptTipoPercep_Ret.rpt", crptToWindow, "Registro de Compras", "", matriz_fecha(), formulas()
    Else
        If Me.optVentas.Value = True Then
            AbreReporteParam gsDSN, Me, rutaReportes & "RptTipoPercep_Ret.rpt", crptToWindow, "Registro de Ventas", "", matriz_fecha(), formulas()
        Else
            AbreReporteParam gsDSN, Me, rutaReportes & "RptRegistroHonorarios.rpt", crptToWindow, "Registro de Honorarios", "", matriz_fecha(), formulas()
        End If
    End If
