...
Me.Caption = Titulo(Me.Caption, TituloSunat)
    ...
    If ReporteSunat = "F0301" Or ReporteSunat = "F0320" Or ReporteSunat = "F0321" Then
         ...
         If vienen <> "" Then Print #1, Space(3) & vienen: sw = True: vienen = ""
            ...
            If mov = 1 Then
                ...
                Do While z < x
                    ...
                    If (NombreMes(gsDiarioPeriodo) = "CIERRE") And intEntro = 0 Then
                        If (CDbl(VarTotal_TM(VarCont + z)) <> 0 And CDbl(VarTotal(VarCont + z)) = 0) Then
                            VarTotal(VarCont + z) = VarTotal_TM(VarCont + z)
                            intEntro = 1
                        End If
                    End If
