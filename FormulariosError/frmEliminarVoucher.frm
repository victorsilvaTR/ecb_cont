...
Begin VB.Form frmEliminarVoucher 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Eliminar rango de vouchers"
   ClientHeight    =   3045
   ClientLeft      =   1770
   ClientTop       =   3810
   ClientWidth     =   6510
   Icon            =   "frmEliminarVoucher.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3045
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcLibro 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmEliminarVoucher.frx":0ECA
      ...
      Begin TDBText6Ctl.TDBText tdbtVoucherIni 
         ...
         _ExtentX        =   2355
         _ExtentY        =   529
         Caption         =   "frmEliminarVoucher.frx":0F51
         ...
         EndProperty
         DropDown        =   "frmEliminarVoucher.frx":0FBD
         Key             =   "frmEliminarVoucher.frx":0FDB
         BackColor       =   16777215
         EditMode        =   0
      ...
      Begin TDBText6Ctl.TDBText tdbtVoucherFin 
         ...
         _ExtentX        =   2355
         _ExtentY        =   529
         Caption         =   "frmEliminarVoucher.frx":102D
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmEliminarVoucher.frx":1099
         Key             =   "frmEliminarVoucher.frx":10B7
         BackColor       =   16777215
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmEliminarVoucher.frx":1109
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdEliminar 
         ...
         Size            =   "2937;767"
         Picture         =   "frmEliminarVoucher.frx":1190
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmEliminarVoucher.frx":172A
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
      End
      Begin VB.Label Label1 
         Caption         =   "(PRESIONE F1 PARA BUSCAR EL RANGO DE VOUCHERS A ELIMINAR)"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmEliminarVoucher"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'--------------------------------------------------------------------------------
'    Component  : frmEliminarVoucher
'    Project    : Contabilidad
'
'    Description: Formulario de Eliminacion de voucher
'--------------------------------------------------------------------------------
Option Explicit

'--------------------------------------------------------------------------------
' Project    :       Contabilidad
' Procedure  :       cmdEliminar_Click
' Description:       Evento que se ejecuta al hacer clic en eliminar voucher
'
' Parameters :
'--------------------------------------------------------------------------------
Private Sub cmdEliminar_Click()
    ...
    Dim i As Integer
    Dim lArrCab(5) As Variant
    Dim clsMante As clsMantoTablas
    Set clsMante = New clsMantoTablas
    
    lArrCab(0) = gsEmpresa
    lArrCab(1) = gsAnio
    lArrCab(2) = tdbcMes.BoundText
    lArrCab(3) = tdbcLibro.BoundText
    lArrCab(4) = tdbtVoucherIni.Text
    lArrCab(5) = tdbtVoucherFin.Text
    
    
    If clsMante.MantenimientoDeTablas(gsCadenaConexion, "spCn_EliminaRangoVouchers", lArrCab(), True) = False Then
    ...
    frmManAsientosContables.ListarDetalle
...
'--------------------------------------------------------------------------------
' Project    :       Contabilidad
' Procedure  :       tdbtVoucherIni_KeyDown
' Description:       Evento que se ejecuta al presioanr una tecla en el voucher ini
'
' Parameters :       KeyCode (Integer)
'                    Shift (Integer)
'--------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------------
' Project    :       Contabilidad
' Procedure  :       tdbtVoucherIni_KeyPress
' Description:       Evento que se ejecuta al presionar una tecla en el voucher ini
'
...
'--------------------------------------------------------------------------------
' Project    :       Contabilidad
' Procedure  :       tdbtVoucherFin_KeyDown
' Description:       Evento que se ejecuta al presionar una teclaen el voucher fin
'
' Parameters :       KeyCode (Integer)
'                    Shift (Integer)
'--------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------------
' Project    :       Contabilidad
' Procedure  :       tdbtVoucherFin_KeyPress
' Description:       Evento que se ejecuta al presioanr una tecla en el voucher fin
'
' Parameters :       KeyAscii (Integer)
'--------------------------------------------------------------------------------
