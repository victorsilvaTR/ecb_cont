...
Begin VB.Form frmRepBalanceSumasSaldos 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Balance de Saldos"
   ClientHeight    =   2685
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6360
   Icon            =   "frmRepBalanceSumasSaldos.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   2685
   ScaleWidth      =   6360
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.Image Image2 
            Height          =   1275
            Left            =   0
            Picture         =   "frmRepBalanceSumasSaldos.frx":1982
            Top             =   -240
            Width           =   1740
         End
      End
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepBalanceSumasSaldos.frx":2562
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepBalanceSumasSaldos.frx":25E9
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TDBText6Ctl.TDBText tdbnDigitos 
         ...
         _ExtentX        =   1005
         _ExtentY        =   556
         Caption         =   "frmRepBalanceSumasSaldos.frx":2670
         ...
         EndProperty
         DropDown        =   "frmRepBalanceSumasSaldos.frx":26DC
         Key             =   "frmRepBalanceSumasSaldos.frx":26FA
   ...
   Begin MSForms.CommandButton cmdImprimir 
      ...
      PicturePosition =   327683
      Size            =   "2937;767"
      Picture         =   "frmRepBalanceSumasSaldos.frx":274C
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   End
End
Attribute VB_Name = "frmRepBalanceSumasSaldos"
...
Private Sub cmdImprimir_Click()
    ...
    AbreReporteParam gsDSN, Me, rutaReportes & "RptBalanceSumasSaldos.rpt", crptToWindow, "Balance de Sumas y Saldos", "", matriz_fecha(), formulas()
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmRepBalanceSumasSaldos = Nothing
End Sub
