            ...
            With FrmManRegAcc.MshMontos
                Select Case sCuenta
                    Case "11" ', "30" And gsTipoPlan = "1"
                        .TextMatrix(x, 2) = MshMov.TextMatrix(VarContador, 3)
                        .TextMatrix(x, 1) = MshMov.TextMatrix(VarContador, 2)
                        .TextMatrix(x, 3) = ""
                        ...
                        .TextMatrix(x, 13) = MshMov.TextMatrix(VarContador, 7)
                        .TextMatrix(x, 14) = MshMov.TextMatrix(VarContador, 1)
                        .TextMatrix(x, 15) = MshMov.TextMatrix(VarContador, 6)
                        .TextMatrix(x, 16) = MshMov.TextMatrix(VarContador, 9)
