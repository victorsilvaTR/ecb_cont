...
Begin VB.Form FrmInventarioAf 
   Caption         =   "Fuentes"
   ClientHeight    =   5535
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   13905
   Icon            =   "FrmInventarioAf.frx":0000
   LinkTopic       =   "Form3"
   ScaleHeight     =   5535
   ScaleWidth      =   13905
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"FrmInventarioAf.frx":0ECA
      ...
      Begin TDBDate6Ctl.TDBDate dtpFechaDoc 
         ...
         _ExtentX        =   2064
         _ExtentY        =   397
         Calendar        =   "FrmInventarioAf.frx":0F51
         Caption         =   "FrmInventarioAf.frx":1053
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "FrmInventarioAf.frx":10B7
         Keys            =   "FrmInventarioAf.frx":10D5
         Spin            =   "FrmInventarioAf.frx":1129
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
      ...
      Begin TDBNumber6Ctl.TDBNumber tdbtPorcx 
         ...
         _ExtentX        =   1720
         _ExtentY        =   661
         Calculator      =   "FrmInventarioAf.frx":1151
         Caption         =   "FrmInventarioAf.frx":1171
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "FrmInventarioAf.frx":11D5
         Keys            =   "FrmInventarioAf.frx":11F3
         Spin            =   "FrmInventarioAf.frx":122D
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   16777215
      ...
      Begin TDBNumber6Ctl.TDBNumber tdbtDepAcu 
         ...
         _ExtentX        =   1720
         _ExtentY        =   661
         Calculator      =   "FrmInventarioAf.frx":1255
         Caption         =   "FrmInventarioAf.frx":1275
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "FrmInventarioAf.frx":12D9
         Keys            =   "FrmInventarioAf.frx":12F7
         Spin            =   "FrmInventarioAf.frx":1331
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   16777215
      ...
      Begin TDBNumber6Ctl.TDBNumber tdbtVU 
         ...
         _ExtentX        =   1720
         _ExtentY        =   661
         Calculator      =   "FrmInventarioAf.frx":1359
         Caption         =   "FrmInventarioAf.frx":1379
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "FrmInventarioAf.frx":13DD
         Keys            =   "FrmInventarioAf.frx":13FB
         Spin            =   "FrmInventarioAf.frx":1435
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   16777215
      ...
      Begin TrueOleDBGrid70.TDBGrid tdbgActivo 
         ...
         Splits(0)._ColumnProps(23)=   "Column(4).Width=2090"
         Splits(0)._ColumnProps(24)=   "Column(4).DividerColor=0"
         Splits(0)._ColumnProps(25)=   "Column(4)._WidthInPix=2011"
         ...
         Splits(0)._ColumnProps(29)=   "Column(5).Width=1799"
         Splits(0)._ColumnProps(30)=   "Column(5).DividerColor=0"
         Splits(0)._ColumnProps(31)=   "Column(5)._WidthInPix=1720"
         Splits(0)._ColumnProps(32)=   "Column(5)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(38)=   "Column(6)._ColStyle=532"
         Splits(0)._ColumnProps(39)=   "Column(6).Visible=0"
         Splits(0)._ColumnProps(40)=   "Column(6).Order=7"
         Splits(0)._ColumnProps(41)=   "Column(7).Width=873"
         Splits(0)._ColumnProps(42)=   "Column(7).DividerColor=0"
         Splits(0)._ColumnProps(43)=   "Column(7)._WidthInPix=794"
         Splits(0)._ColumnProps(44)=   "Column(7)._ColStyle=530"
         Splits(0)._ColumnProps(45)=   "Column(7).Order=8"
         Splits(0)._ColumnProps(46)=   "Column(8).Width=1349"
         Splits(0)._ColumnProps(47)=   "Column(8).DividerColor=0"
         Splits(0)._ColumnProps(48)=   "Column(8)._WidthInPix=1270"
         Splits(0)._ColumnProps(49)=   "Column(8)._ColStyle=530"
         ...
         Splits(0)._ColumnProps(54)=   "Column(9)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(60)=   "Column(10)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(66)=   "Column(11)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(72)=   "Column(12)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(78)=   "Column(13)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(84)=   "Column(14)._ColStyle=532"
         ...
         Splits(0)._ColumnProps(90)=   "Column(15)._ColStyle=532"
         Splits(0)._ColumnProps(91)=   "Column(15).Visible=0"
         Splits(0)._ColumnProps(92)=   "Column(15).Order=16"
         Splits(0)._ColumnProps(93)=   "Column(16).Width=1931"
         Splits(0)._ColumnProps(94)=   "Column(16).DividerColor=0"
         Splits(0)._ColumnProps(95)=   "Column(16)._WidthInPix=1852"
         Splits(0)._ColumnProps(96)=   "Column(16)._ColStyle=530"
         Splits(0)._ColumnProps(97)=   "Column(16).Order=17"
         Splits(0)._ColumnProps(98)=   "Column(17).Width=1931"
         Splits(0)._ColumnProps(99)=   "Column(17).DividerColor=0"
         Splits(0)._ColumnProps(100)=   "Column(17)._WidthInPix=1852"
         Splits(0)._ColumnProps(101)=   "Column(17)._ColStyle=530"
         Splits(0)._ColumnProps(102)=   "Column(17).Order=18"
         Splits(0)._ColumnProps(103)=   "Column(18).Width=2381"
         Splits(0)._ColumnProps(104)=   "Column(18).DividerColor=0"
         Splits(0)._ColumnProps(105)=   "Column(18)._WidthInPix=2302"
         Splits(0)._ColumnProps(106)=   "Column(18)._ColStyle=530"
         Splits(0)._ColumnProps(107)=   "Column(18).Order=19"
         Splits(0)._ColumnProps(108)=   "Column(19).Width=1984"
         Splits(0)._ColumnProps(109)=   "Column(19).DividerColor=0"
         Splits(0)._ColumnProps(110)=   "Column(19)._WidthInPix=1905"
         Splits(0)._ColumnProps(111)=   "Column(19)._ColStyle=530"
         Splits(0)._ColumnProps(112)=   "Column(19).AllowFocus=0"
         Splits(0)._ColumnProps(113)=   "Column(19).Order=20"
         Splits(0)._ColumnProps(114)=   "Column(20).Width=2725"
         Splits(0)._ColumnProps(115)=   "Column(20).DividerColor=0"
         Splits(0)._ColumnProps(116)=   "Column(20)._WidthInPix=2646"
         Splits(0)._ColumnProps(117)=   "Column(20)._ColStyle=530"
         Splits(0)._ColumnProps(118)=   "Column(20).AllowFocus=0"
         Splits(0)._ColumnProps(119)=   "Column(20).Order=21"
         Splits.Count    =   1
      ...
      Begin TDBNumber6Ctl.TDBNumber tdbtPorc 
         ...
         _ExtentX        =   1720
         _ExtentY        =   661
         Calculator      =   "FrmInventarioAf.frx":145D
         Caption         =   "FrmInventarioAf.frx":147D
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "FrmInventarioAf.frx":14E1
         Keys            =   "FrmInventarioAf.frx":14FF
         Spin            =   "FrmInventarioAf.frx":1539
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   1
         BackColor       =   16777215
      ...
      Begin MSForms.CommandButton CommandButton2 
         ...
         Size            =   "2434;661"
         Picture         =   "FrmInventarioAf.frx":1561
         FontName        =   "Tahoma"
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CommandButton1 
         ...
         PicturePosition =   327683
         Size            =   "2434;661"
         Picture         =   "FrmInventarioAf.frx":1AFB
         FontName        =   "Tahoma"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.CommandButton cmdEliminaItem 
         ...
         PicturePosition =   327683
         Size            =   "2434;661"
         Picture         =   "FrmInventarioAf.frx":2095
         FontName        =   "Tahoma"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         PicturePosition =   327683
         Size            =   "2381;688"
         Picture         =   "FrmInventarioAf.frx":262F
         FontName        =   "Tahoma"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
      ...
      Begin MSForms.CommandButton cmdRefresh 
         ...
         PicturePosition =   327683
         Size            =   "2434;661"
         Picture         =   "FrmInventarioAf.frx":2BC9
         FontName        =   "Tahoma"
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":3163
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":353D
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":3917
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":3CF1
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":40CB
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":44A5
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":487F
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":4C59
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imglstTool 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   9
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":5C73
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":620D
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":67A7
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":6D41
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":72DB
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":7875
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":7E0F
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":83A9
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":8943
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imglstdisabled 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   9
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":8EDD
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":9037
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":9191
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":92EB
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":9445
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":959F
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":96F9
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":9853
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmInventarioAf.frx":99AD
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "FrmInventarioAf"
