...
Begin VB.Form frmManLibros 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Registro de Libros"
   ClientHeight    =   5955
   ClientLeft      =   3030
   ClientTop       =   2985
   ClientWidth     =   7950
   Icon            =   "frmManLibros.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab SSTCentroCosto 
      ...
      TabsPerRow      =   2
      TabHeight       =   520
      TabCaption(0)   =   "Consultas de Libro"
      TabPicture(0)   =   "frmManLibros.frx":0ECA
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Mantenimiento de Libro"
      TabPicture(1)   =   "frmManLibros.frx":0EE6
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TDBText6Ctl.TDBText tdbtCodigo 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmManLibros.frx":0F6E
            Key             =   "frmManLibros.frx":0F8C
         ...
         Begin TDBText6Ctl.TDBText tdbtDescripcion 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmManLibros.frx":104A
            Key             =   "frmManLibros.frx":1068
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   0
         ...
         Begin TrueOleDBList70.TDBCombo tdbcEntidad 
            ...
            AddItemSeparator=   ";"
            _PropDict       =   $"frmManLibros.frx":10AC
         ...
         Begin TDBText6Ctl.TDBText tdbtCodSunat 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmManLibros.frx":119F
            Key             =   "frmManLibros.frx":11BD
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid tdbgCostos 
            ...
            _StyleDefs(42)  =   "Splits(0).Columns(1).Style:id=62,.parent=13"
            ...
            _StyleDefs(50)  =   "Splits(0).Columns(3).Style:id=28,.parent=13"
         ...
         Begin TDBText6Ctl.TDBText tdbtDescripcionBus 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmManLibros.frx":127B
            Key             =   "frmManLibros.frx":1299
            BackColor       =   -2147483643
            EditMode        =   0
            ForeColor       =   -2147483640
            ReadOnly        =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":12EB
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":16C5
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":1A9F
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":1E79
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":2253
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":262D
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":2A07
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":2DE1
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imglstdisabled 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   9
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":3DFB
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":3F55
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":40AF
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":4209
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":4363
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":44BD
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":4617
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":4771
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":48CB
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imglstTool 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   9
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":4A25
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":4FBF
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":5559
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":5AF3
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":608D
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":6627
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":6BC1
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":715B
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManLibros.frx":76F5
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmManLibros"
...
Private Sub chkEntidad_Click()
    ...
    End If
End Sub
Private Sub chkEntidad_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then pSendKeys "{TAB}"
    If KeyAscii = 48 Then chkEntidad.Value = 0
    If KeyAscii = 49 Then chkEntidad.Value = 1
End Sub
...
On Error GoTo errHand
    If Me.WindowState <> vbMinimized Then
        ...
        '*** REDIMENSIONAR SST
        SSTCentroCosto.Width = Me.Width - SSTCentroCosto.Left + 15 - 300
        SSTCentroCosto.Height = Me.Height - SSTCentroCosto.Top + 15 - 500
        '*** REDIMENSIONAR FRAME PRINCIPAL
        Frame1.Width = SSTCentroCosto.Width - IIf(SSTCentroCosto.TabOrientation = ssTabOrientationLeft, SSTCentroCosto.TabHeight, 0) - 400
        Frame1.Height = SSTCentroCosto.Height - IIf(SSTCentroCosto.TabOrientation = ssTabOrientationTop, SSTCentroCosto.TabHeight, 0) - 500
       
        
        '*** REDIMENSIONAR DETALLE
        Frame2.Width = SSTCentroCosto.Width - IIf(SSTCentroCosto.TabOrientation = ssTabOrientationLeft, SSTCentroCosto.TabHeight, 0) - 600
        Frame2.Height = SSTCentroCosto.Height - IIf(SSTCentroCosto.TabOrientation = ssTabOrientationTop, SSTCentroCosto.TabHeight, 0) - 1600
        
    
        '*** REDIMENSIONAR CUADRICULA DE LISTADO
         
        tdbgCostos.Width = Frame1.Left + Frame1.Width - tdbgCostos.Left - 600
        tdbgCostos.Height = Frame1.Top + Frame1.Height - tdbgCostos.Top - 800
...
Private Sub Borrar()
    ...
    If Trim(tdbgCostos.Columns(0).Value) <> "" Then
        ' *** Antes de eliminar verificar q no sea cuenta de titulo
        If VerificaDependencias = True Then
            Mensajes "Se han registrado asientos con este Registro. Eliminelos primero, para poder eliminar Registro...", vbInformation
            Exit Sub
        End If
        ...
        If respuesta = vbYes Then
            ...
            lArrMnt(3) = tdbgCostos.Columns(1).Value    ' Codigo
            If clsMante.MantenimientoDeTablas(gsCadenaConexion, "spCn_GrabaLibroOpera", lArrMnt(), True) = False Then
...
Dim matriz(9) As Variant
    Dim Tipo As String
            ...
            matriz(8) = "@EMPRESA;" & gsEmpresaNom & ";True"
            matriz(9) = "@RUC;" & "RUC : " & gsRUC & ";True"
    
    Dim formulas(0) As Variant
       AbreReporteParam gsDSN, Me, rutaReportes & "RptTipoComprobante.rpt", crptToWindow, "Tipos de Comprobantes", "", matriz(), formulas()
...
Private Sub CargaArregloMnt()
    ...
    lArrMnt(3) = tdbgCostos.Columns(1)           ' Codigo
    lArrMnt(4) = tdbtDescripcion    ' Nombre
    lArrMnt(5) = CboTipOpe.ListIndex ' Nombre
    lArrMnt(6) = "A"
    lArrMnt(7) = gsUsuario
    lArrMnt(8) = CE(tdbtCodSunat.Text)
...
Private Sub Form_Load()
    ...
    'llenado de combo tipo de Operacion
    CboTipOpe.AddItem "Ninguno"
    CboTipOpe.AddItem "VENTAS"
    CboTipOpe.AddItem "COMPRAS"
    ...
    LlenarComboAddItem Me.tdbcEntidad, sqlcombos
...
Private Sub CargaTabla()
    ...
    sqlSp = "spCn_GrabaLibroOpera 'SEL_ALL', '" & gsEmpresa & "', '" & gsAnio & "'"
    ...
    If Not lrsTabla Is Nothing Then
        ...
        lrsTabla.Sort = "Lib_cDescripcion"
...
Private Sub CargaDatosRegistro()
    ...
    With tdbgCostos
    sqlSp = "spCn_GrabaLibroOpera 'SEL_REG', '" & gsEmpresa & "', '" & .Columns(0).Value & "', '" & .Columns(1).Value & "'"
    End With
    arrDatos = Array(sqlSp)
    ...
    tdbtCodigo = CE(rsArreglo!Lib_cTipoLibro)
    tdbtDescripcion = CE(rsArreglo!Lib_cDescripcion)
    CboTipOpe.ListIndex = Val(NE(rsArreglo!Lib_cTipOpe))
    tdbtCodSunat.Text = CE(rsArreglo!Lib_cCodSunat)
    'If Trim(NuloText(rsArreglo!Ten_cTipoEntidad)) <> "" Then
    '    chkEntidad.Value = 1
    '    tdbcEntidad.BoundText = rsArreglo!Ten_cTipoEntidad
    'Else
    '    chkEntidad.Value = 0
    '    tdbcEntidad.BoundText = ""
    'End If
...
Private Sub FiltrarRecordSet()
    ...
    cadena = ""
    If Trim(tdbtDescripcionBus) <> "" Then filtros(0) = "Lib_cDescripcion like '*" & tdbtDescripcionBus & "*'"
    For i = 0 To 0
        If filtros(i) <> "" Then
            If cadena = "" Then
...
Private Sub tdbtCodigo_LostFocus()
    ...
    If SSTCentroCosto.TabEnabled(1) = True And lTipoMnt = "INSERTAR" Then
        If ExisteRegistro(tdbtCodigo, "spCn_GrabaLibroOpera", True) = True Then
    ...
    End If
End Sub
Private Function VerificaDependencias() As Boolean
    Dim rsArreglo As New ADODB.Recordset
    Dim clDatos As clsMantoTablas
    
    VerificaDependencias = False
    Set clDatos = New clsMantoTablas
    Dim arrDatos() As Variant
    ' *** Cargando Datos de la Cuenta
    Dim sqlSp As String
    ...
    With tdbgCostos
    sqlSp = "spCn_GrabaLibroOpera 'SEL_MVTOS', '" & gsEmpresa & "', '" & .Columns(0).Value & "', '" & .Columns(1).Value & "'"
    End With
    arrDatos = Array(sqlSp)
    Set rsArreglo = clDatos.ConsultaDatosTabla(gsCadenaConexion, "pSTD_EjecutaQuery", arrDatos())
    If rsArreglo.State = 0 Then
        ...
        Exit Function
    End If
    If rsArreglo(0).Value > 0 Then VerificaDependencias = True
    Call CerrarRecordSet(rsArreglo)
    ' ***
End Function
