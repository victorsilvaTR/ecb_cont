...
On Error GoTo MIERROR
    Dim i As Integer
    Dim u As Integer
    For u = 0 To Me.tdbgActivo.ApproxCount - 1
        arrDet(u, 0) = tdbgActivo.Columns(0).CellValue(u)
        arrDet(u, 1) = tdbgActivo.Columns(1).CellValue(u)
        arrDet(u, 2) = tdbgActivo.Columns(2).CellValue(u)
        arrDet(u, 3) = tdbgActivo.Columns(3).CellValue(u)
        arrDet(u, 4) = tdbgActivo.Columns(4).CellValue(u)
        arrDet(u, 5) = tdbgActivo.Columns(5).CellValue(u)
        arrDet(u, 6) = tdbgActivo.Columns(6).CellValue(u)
        arrDet(u, 7) = tdbgActivo.Columns(7).CellValue(u)
        arrDet(u, 8) = tdbgActivo.Columns(8).CellValue(u)
        arrDet(u, 9) = tdbgActivo.Columns(9).CellValue(u)
        arrDet(u, 10) = RTrim(LTrim(tdbgActivo.Columns(10).CellValue(u)))
        arrDet(u, 11) = RTrim(LTrim(tdbgActivo.Columns(11).CellValue(u)))
        arrDet(u, 12) = RTrim(LTrim(tdbgActivo.Columns(12).CellValue(u)))
        arrDet(u, 13) = RTrim(LTrim(tdbgActivo.Columns(13).CellValue(u)))
        arrDet(u, 14) = RTrim(LTrim(tdbgActivo.Columns(14).CellValue(u)))
        arrDet(u, 15) = tdbgActivo.Columns(15).CellValue(u)
        arrDet(u, 16) = tdbgActivo.Columns(16).CellValue(u)
        arrDet(u, 17) = tdbgActivo.Columns(17).CellValue(u)
        arrDet(u, 18) = tdbgActivo.Columns(18).CellValue(u)
        arrDet(u, 19) = tdbgActivo.Columns(19).CellValue(u)
        arrDet(u, 20) = tdbgActivo.Columns(20).CellValue(u)
    Next
...
'        Call Centrar_Objeto(Me.Frame1, Me)
'        Me.Frame1.Width = Me.Width - 500
'        tdbgActivo.Width = Me.Width - 300
'    End If
'
'    Exit Sub
'errHand:
