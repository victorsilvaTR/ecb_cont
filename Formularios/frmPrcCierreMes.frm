...
Private Sub Llenarlibros()
    ...
    'Se modifica ya que estaban en duro los datos del combo JCS OCTALIA S.A. 21/03/2017 (CHILE)
    Dim sqlcombos  As String
    ' *** Llenado de Catalogos
    sqlcombos = "SELECT Lib_cTipoLibro, Lib_cDescripcion From CNT_LIBRO_OPERA WHERE Emp_cCodigo= '" & gsEmpresa & "' AND Pan_cAnio = '" & gsAnio & "' ORDER BY Emp_cCodigo, Pan_cAnio, Lib_cTipoLibro"
    LlenarComboAddItem TDBLibro, sqlcombos
End Sub
