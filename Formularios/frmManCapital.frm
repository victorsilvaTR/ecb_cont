...
Begin VB.Form frmManCapital 
   ...
   Begin VB.Frame fraLeyenda 
      ...
      Begin VB.Label Label13 
         AutoSize        =   -1  'True
         Caption         =   "Voucher con tipo de acción invalido"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame fraEstructura 
      Caption         =   " ESTRUCTURA DE PARTICIPACIÓN ACCIONARIA O DE PARTICIPACIONES SOCIALES: "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
' Description:       Evento que se ejecuta al cambiar el tamaño del formulario
'
' Parameters :
'--------------------------------------------------------------------------------
