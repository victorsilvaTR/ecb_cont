...
Begin VB.Form frmRepSeguimientoCheques 
   ...
   ClientTop       =   450
   ClientWidth     =   4905
   Icon            =   "frmRepSeguimientoCheques.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3450
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TrueOleDBList70.TDBCombo tdbcMes 
            ...
            AddItemSeparator=   ";"
            _PropDict       =   $"frmRepSeguimientoCheques.frx":0ECA
         ...
         Begin TrueOleDBList70.TDBCombo tdbcBancoBus 
            ...
            RowSubDividerColor=   12632256
            AddItemSeparator=   ";"
            _PropDict       =   $"frmRepSeguimientoCheques.frx":0F51
            _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
            _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
            _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
            _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
         ...
         Begin TrueOleDBList70.TDBCombo tdbcCuentaBus 
            ...
            RowSubDividerColor=   12632256
            AddItemSeparator=   ";"
            _PropDict       =   $"frmRepSeguimientoCheques.frx":0FD8
            _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
            _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
            _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
            _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         Size            =   "2937;767"
         Picture         =   "frmRepSeguimientoCheques.frx":105F
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton cmdImprimir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmRepSeguimientoCheques.frx":15F9
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepSeguimientoCheques"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim lBolActivo As Boolean
Dim lsCodCheque As String
...
'    tdbcMoneda.ReBind
    ...
    tdbcCuentaBus.DropdownWidth = tdbcCuentaBus.Width + 200 + tdbcCuentaBus.Width / 3
End Sub
...
Private Sub cmdImprimir_Click()
    ...
    lsCodCheque = fgDocCfgOpera("019")
    If Trim(lsCodCheque) = "" Then
    ...
    matriz_fecha(3) = "@td;" & lsCodCheque & ";True"
    
    matriz_fecha(5) = "@EMPRESA;" & gsEmpresaNom & ";True"
    matriz_fecha(6) = "@RUC;" & "RUC : " & gsRUC & ";True"
    matriz_fecha(7) = "@moneda;" & gsMonedaNac & ";True"
    
    If chkTodos.Value = vbUnchecked Then
        matriz_fecha(4) = "@Banco;" & tdbcBancoBus.BoundText & ";True"
    Else
        matriz_fecha(4) = "@Banco;*;True"
    End If
    
    If chkTodasCuentas.Value = vbUnchecked Then
        matriz_fecha(8) = "@cuenta;" & tdbcCuentaBus.BoundText & ";True"
    Else
        matriz_fecha(8) = "@cuenta;;True"
    End If
    
    cmdImprimir.Enabled = False
    Dim formulas(0) As Variant
    AbreReporteParam gsDSN, Me, rutaReportes & "RptRelacionCheque.rpt", crptToWindow, "Reporte de Listado de Cheques por Bancos", "", matriz_fecha(), formulas()
