...
Begin VB.Form frmRepBalanceResultadosConasev 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Anexos de E.E.F.F. (Conasev)"
   ClientHeight    =   3495
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7350
   Icon            =   "frmRepBalanceResultadosConasev.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3495
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   120
      Width           =   7095
      Begin VB.OptionButton optBalanceGeneral 
         ...
         Width           =   3855
      End
      Begin VB.OptionButton optEstadoFuncion 
         Caption         =   "ESTADO DE RESULTADOS POR FUNCION"
         Height          =   195
         Left            =   2520
         TabIndex        =   1
         Top             =   720
         Width           =   3855
      End
      Begin VB.OptionButton optEstadoNaturaleza 
         Caption         =   "ESTADO DE RESULTADOS POR NATURALEZA"
         Height          =   195
         Left            =   2520
         TabIndex        =   2
         Top             =   1080
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.Image Image2 
            Height          =   1275
            Left            =   0
            Picture         =   "frmRepBalanceResultadosConasev.frx":1982
            Top             =   -255
            Width           =   1740
         End
      End
   ...
   Begin TrueOleDBList70.TDBCombo tdbcMes 
      ...
      AddItemSeparator=   ";"
      _PropDict       =   $"frmRepBalanceResultadosConasev.frx":2562
   ...
   Begin TrueOleDBList70.TDBCombo tdbcMoneda 
      ...
      RowSubDividerColor=   12632256
      AddItemSeparator=   ";"
      _PropDict       =   $"frmRepBalanceResultadosConasev.frx":25E9
      _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
      _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
      _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
      _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin MSForms.CommandButton cmdImprimir 
      ...
      Size            =   "2937;767"
      Picture         =   "frmRepBalanceResultadosConasev.frx":2670
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton cmdSalir 
      ...
      PicturePosition =   327683
      Size            =   "2937;767"
      Picture         =   "frmRepBalanceResultadosConasev.frx":2C0A
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepBalanceResultadosConasev"
...
Private Sub chkAnexos_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        pSetFocus tdbcMes
    End If
End Sub
...
Private Sub cmdImprimir_Click()
    ...
    ' ***
    If optBalanceGeneral.Value = True Then Tipo = "BGE"
    If optEstadoFuncion.Value = True Then Tipo = "FUN"
    If optEstadoNaturaleza.Value = True Then Tipo = "NAT"
    If optBalanceGeneral.Value = True Then Titulo = optBalanceGeneral.Caption
    If optEstadoFuncion.Value = True Then Titulo = optEstadoFuncion.Caption
    If optEstadoNaturaleza.Value = True Then Titulo = optEstadoNaturaleza.Caption
    ...
    matriz_fecha(7) = "@RUC;" & "RUC : " & gsRUC & ";true"
    matriz_fecha(8) = "@NOMMONEDA;" & tdbcMoneda.Text & ";true"
    
    Dim formulas(0) As Variant
    cmdImprimir.Enabled = False
    If chkAnexos.Value = "1" Then
        matriz_fecha(5) = "@Reporte;DETALLE;true"
        AbreReporteParam gsDSN, Me, rutaReportes & "RptBalanceGeneralConasevDetalle.rpt", crptToWindow, Titulo, "", matriz_fecha(), formulas()
    Else
        matriz_fecha(5) = "@Reporte;RESUMEN;true"
        AbreReporteParam gsDSN, Me, rutaReportes & "RptBalanceGeneralConasev.rpt", crptToWindow, Titulo, "", matriz_fecha(), formulas()
    End If
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmRepBalanceResultadosConasev = Nothing
End Sub

Private Sub optBalanceGeneral_Click()
    If optBalanceGeneral.Value = True Then
        chkAnexos.Value = vbChecked
        chkAnexos.Enabled = False
    End If
End Sub

Private Sub optBalanceGeneral_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
...
Private Sub optEstadoFuncion_Click()
    If optEstadoFuncion.Value = True Then
        chkAnexos.Value = vbChecked
        chkAnexos.Enabled = False
    End If
End Sub

Private Sub optEstadoFuncion_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
...
Private Sub optEstadoNaturaleza_Click()
    If optEstadoNaturaleza.Value = True Then
        chkAnexos.Value = vbChecked
        chkAnexos.Enabled = True
    End If
End Sub

Private Sub optEstadoNaturaleza_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
