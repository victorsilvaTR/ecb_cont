...
Begin VB.Form frmRepPresupuestoEjecucion 
   ...
   ClientTop       =   450
   ClientWidth     =   5850
   Icon            =   "frmRepPresupuestoEjecucion.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepPresupuestoEjecucion.frx":0ECA
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepPresupuestoEjecucion.frx":0F51
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         Size            =   "2937;767"
         Picture         =   "frmRepPresupuestoEjecucion.frx":0FD8
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton cmdImprimir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmRepPresupuestoEjecucion.frx":1572
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepPresupuestoEjecucion"
...
Private Sub cmdImprimir_Click()
    ...
    If Me.optGastos.Value = True Then
        matriz_fecha(3) = "@Imb_cTipoDeuAcr;" & "G" & ";True"
    Else
        matriz_fecha(3) = "@Imb_cTipoDeuAcr;" & "I" & ";True"
    End If
    
    If optTipo(0).Value = True Then
        sreporte = "RptPresupuestoEjecucion.rpt"
    Else
        sreporte = "RptPresupuestoEjecucionAnual.rpt"
    End If
    
    matriz_fecha(4) = "@moneda;" & tdbcMoneda.BoundText & ";True"
    matriz_fecha(5) = "@NomPeriodo;" & tdbcMes.Text & ";True"
    
    matriz_fecha(6) = "@EMPRESA;" & gsEmpresaNom & ";True"
    matriz_fecha(7) = "@RUC;" & "RUC : " & gsRUC & ";True"
    
    Dim formulas(0) As Variant
    AbreReporteParam gsDSN, Me, rutaReportes & sreporte, crptToWindow, "Presupuesto vs Ejecución", "", matriz_fecha(), formulas()
