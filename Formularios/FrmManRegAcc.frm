...
'    Call Sb_Formatear_Grilla(MshEmp)
    With MshMontos
        If sCuenta = "11" Then
            .FormatString = "|Apellidos y Nombres, Razon Social|R.U.C.|Denominación|Valor Nominal Unitario|Cantidad|Costo Total|Provisión Total|Otros Costos|Total Neto||||"
...
If MshMontos.TextMatrix(nroRegIni, 3) = "" Then Exit Sub
MshMontos.SetFocus
MshMontos.AddItem ""
