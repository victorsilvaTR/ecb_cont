   ...
   Begin TabDlg.SSTab SSTCentroCosto 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame fraPrivilegio 
            ...
            Begin TrueOleDBList70.TDBCombo tdbcGrupo 
               ...
               Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=1630"
      ...
      Begin VB.Frame Frame2 
         ...
         Begin TrueOleDBList70.TDBCombo tdbcUsuario 
            ...
            Splits(0)._PropDict=   "_ColumnProps,515,0;_UserFlags,518,3"
            Splits(0)._ColumnProps(0)=   "Columns.Count=3"
            Splits(0)._ColumnProps(1)=   "Column(0).Width=2307"
            Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
            Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=2244"
            Splits(0)._ColumnProps(4)=   "Column(0)._EditAlways=0"
            Splits(0)._ColumnProps(5)=   "Column(0).Order=1"
            Splits(0)._ColumnProps(6)=   "Column(1).Width=826"
            Splits(0)._ColumnProps(7)=   "Column(1).DividerColor=0"
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid tdbgCostos 
            ...
            Splits(0)._ColumnProps(1)=   "Column(0).Width=2159"
            Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
            ...
            Splits(0)._ColumnProps(8)=   "Column(1).Width=6498"
            Splits(0)._ColumnProps(9)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(10)=   "Column(1)._WidthInPix=6414"
            Splits(0)._ColumnProps(11)=   "Column(1)._EditAlways=0"
            Splits(0)._ColumnProps(12)=   "Column(1)._ColStyle=532"
            Splits(0)._ColumnProps(13)=   "Column(1).Order=2"
            Splits(0)._ColumnProps(14)=   "Column(1).Merge=1"
            Splits(0)._ColumnProps(15)=   "Column(2).Width=5990"
            Splits(0)._ColumnProps(16)=   "Column(2).DividerColor=0"
            Splits(0)._ColumnProps(17)=   "Column(2)._WidthInPix=5906"
            ...
            Splits(0)._ColumnProps(21)=   "Column(3).Width=2731"
            ...
            Splits(0)._ColumnProps(30)=   "Column(4).Width=2731"
