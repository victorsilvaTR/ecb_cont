...
'    End If
    ...
    If ReporteSunat = "" And gstrCuentaCostoVenta <> "69" Then
    ...
    ElseIf ReporteSunat = "" And gstrCuentaCostoVenta = "69" Then
        AbreReporteParam gsDSN, Me, rutaReportes & "RptBalanceComprobacionNuevo.rpt", crptToWindow, "Balance de Comprobación", "", matriz_fecha(), formulas()
    ElseIf ReporteSunat = "F0317" And gstrCuentaCostoVenta <> "69" Then
        AbreReporteParam gsDSN, Me, rutaReportes & "RptFormato_0317.rpt", crptToWindow, "Balance de Comprobación", "", matriz_fecha(), formulas()
    ElseIf ReporteSunat = "F0317" And gstrCuentaCostoVenta = "69" Then
        AbreReporteParam gsDSN, Me, rutaReportes & "RptFormato_0317Nuevo.rpt", crptToWindow, "Balance de Comprobación", "", matriz_fecha(), formulas()
    ElseIf ReporteSunat = "F0317_2" And gstrCuentaCostoVenta <> "69" Then
        AbreReporteParam gsDSN, Me, rutaReportes & "RptFormato_0317_2.rpt", crptToWindow, "Balance de Comprobación", "", matriz_fecha(), formulas()
    ElseIf ReporteSunat = "F0317_2" And gstrCuentaCostoVenta = "69" Then
        AbreReporteParam gsDSN, Me, rutaReportes & "RptFormato_0317_2.1.rpt", crptToWindow, "Balance de Comprobación", "", matriz_fecha(), formulas()
    End If
...
Private Sub Command1_Click()
    ShellExecute hwnd, "open", "http://www.distnconline.com/localbc/importbalance/suscriptor/controller/controller_index.php?Key=balano30y&xR=" & gsRUC & "&Cabnv=" & gsRUC & "&df=734ujsdmxze", vbNullString, vbNullString, conSwNormal
End Sub

Private Sub Form_Load()
    
    If frmRepBalanceComprobacion.BalanceWeb = "1" Then
