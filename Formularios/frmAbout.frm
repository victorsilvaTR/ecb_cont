...
Private Sub Form_Load()
    ...
    aMensaje(1) = "THOMSON REUTERS PERU S.A.C." & vbNewLine
    aMensaje(4) = "" & vbNewLine
    'aMensaje(5) = propPrograma & vbNewLine
    'aMensaje(6) = ""
    'aMensaje(7) = "" & vbNewLine
    aMensaje(5) = "AV. VICTOR ANDRES BELAUNDE NRO. 147" & vbNewLine
    aMensaje(6) = "EL ROSARIO (EDIFICIO REAL 6 - PISO 6) LIMA - LIMA - SAN ISIDRO" & vbNewLine
    aMensaje(7) = "" & vbNewLine
    aMensaje(8) = "Central Telefónica: (511) 707-5933" & vbNewLine
    aMensaje(9) = "" & vbNewLine
    aMensaje(10) = "LIMA - PERU" & vbNewLine
    aMensaje(11) = "2008"
    nItemTop = 0
    lblNormal = ""
