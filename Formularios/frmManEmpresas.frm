...
Begin VB.Form frmManEmpresas 
   ...
   Begin TabDlg.SSTab SSTCentroCosto 
      ...
      Tab(2).Control(0)=   "Label2(14)"
      Tab(2).Control(1)=   "Label2(15)"
      Tab(2).Control(2)=   "cmdExportar"
      Tab(2).Control(3)=   "cmdRefresh"
      Tab(2).Control(4)=   "cmdRefreshDestino"
      Tab(2).Control(5)=   "cmdEliminarEjercicio"
      Tab(2).Control(6)=   "tdbcAnioDest"
      Tab(2).Control(7)=   "tdbcEmpresaDest"
      Tab(2).Control(8)=   "tdbcAnio"
      Tab(2).Control(9)=   "tdbcEmpresa"
      Tab(2).Control(10)=   "Frame3"
      Tab(2).Control(11)=   "Frame4(2)"
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TrueOleDBGrid70.TDBGrid tdbgCostos 
            ...
            Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=995"
            Splits(0)._ColumnProps(4)=   "Column(0)._EditAlways=0"
            Splits(0)._ColumnProps(5)=   "Column(0)._ColStyle=532"
            Splits(0)._ColumnProps(6)=   "Column(0).Order=1"
            Splits(0)._ColumnProps(7)=   "Column(1).Width=6435"
            ...
            Splits(0)._ColumnProps(13)=   "Column(2).Width=2731"
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame5 
            ...
            Visible         =   0   'False
            Width           =   2712
            Begin VB.OptionButton OptTipoRegimen 
               Caption         =   "RER"
               BeginProperty Font 
                  Name            =   "Arial"
                  Size            =   9
         ...
         Begin TrueOleDBList70.TDBCombo tdbcSucursal 
            ...
            Splits(0)._PropDict=   "_ColumnProps,515,0;_UserFlags,518,3"
            Splits(0)._ColumnProps(0)=   "Columns.Count=3"
            Splits(0)._ColumnProps(1)=   "Column(0).Width=614"
            Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
            ...
            Splits(0)._ColumnProps(11)=   "Column(2).Width=1143"
            ...
            _StyleDefs(4)   =   ":id=0,.underline=0,.strikethrough=0,.charset=0"
            _StyleDefs(5)   =   ":id=0,.fontname=MS Sans Serif"
            _StyleDefs(6)   =   "Style:id=1,.parent=0,.namedParent=33,.bgcolor=&H80000005&,.bold=0,.fontsize=900"
            _StyleDefs(7)   =   ":id=1,.italic=0,.underline=0,.strikethrough=0,.charset=0"
            _StyleDefs(8)   =   ":id=1,.fontname=Arial"
            _StyleDefs(9)   =   "CaptionStyle:id=4,.parent=2,.namedParent=37"
      ...
      Begin TrueOleDBList70.TDBCombo tdbcAnio 
         ...
         Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
         Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=2265"
         Splits(0)._ColumnProps(4)=   "Column(0)._EditAlways=0"
         Splits(0)._ColumnProps(5)=   "Column(0).Visible=0"
         Splits(0)._ColumnProps(6)=   "Column(0).Order=1"
         Splits(0)._ColumnProps(7)=   "Column(1).Width=148"
         Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=85"
         Splits(0)._ColumnProps(10)=   "Column(1)._EditAlways=0"
...
Private Sub CargaArregloMnt()
    ...
    lArrMnt(11) = CE(Me.chkPercepcion.Value)
    lArrMnt(12) = CE(Me.chkRetencion.Value)
    
    
    gintPercepcion = lArrMnt(11)
    gintRetencion = lArrMnt(12)
  
    If OptTipoRegimen(0).Value Then 'frt_rvie
        gintTipoRegimen = 0
    Else
        gintTipoRegimen = 1
    End If
    lArrMnt(13) = gintTipoRegimen
...
'    End If
    Me.chkPercepcion.Value = CE(rsArreglo!Emp_AgentePercepcion)
    Me.chkRetencion.Value = CE(rsArreglo!Emp_AgenteRetencion)
'    If CE(rsArreglo!Emp_TipoRegimen) = "1" Then 'frt_rvie
'        OptTipoRegimen(1).Value = True
'    Else
'        OptTipoRegimen(0).Value = True
'    End If
