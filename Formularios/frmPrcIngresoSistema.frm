...
Begin VB.Form frmPrcIngresoSistema 
   ...
   Begin TDBText6Ctl.TDBText txtUsuario 
      ...
      _ExtentX        =   5900
      _ExtentY        =   503
      Caption         =   "frmPrcIngresoSistema.frx":728F
      ...
      EndProperty
      DropDown        =   "frmPrcIngresoSistema.frx":72FB
      Key             =   "frmPrcIngresoSistema.frx":7319
   ...
   Begin TDBText6Ctl.TDBText txtpassword 
      ...
      _ExtentX        =   2725
      _ExtentY        =   503
      Caption         =   "frmPrcIngresoSistema.frx":7355
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   8.4
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmPrcIngresoSistema.frx":73C1
      Key             =   "frmPrcIngresoSistema.frx":73DF
      BackColor       =   -2147483643
      EditMode        =   3
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin MSForms.CommandButton cmdAceptar 
      ...
      Size            =   "2699;688"
      Picture         =   "frmPrcIngresoSistema.frx":7423
      FontHeight      =   165
      FontCharSet     =   0
...
'    If DateDiff("d", Format(Date, "dd/MM/yyyy"), Format("09/11/2016", "dd/MM/yyyy")) < 0 Then
