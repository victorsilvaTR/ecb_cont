...
Begin VB.Form frmManPDBVentas 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "PDB - Carga de Comprobantes de Ventas"
   ClientHeight    =   5970
   ClientLeft      =   1200
   ClientTop       =   3570
   ClientWidth     =   12465
   Icon            =   "frmManPDBVentas.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   5970
   ...
   End
   Begin TrueOleDBGrid70.TDBDropDown tdbdPercepciones 
      Height          =   2505
      Left            =   4365
      TabIndex        =   16
      Top             =   2385
   ...
   Begin TDBDate6Ctl.TDBDate tdbdFecha 
      ...
      _ExtentX        =   2196
      _ExtentY        =   529
      Calendar        =   "frmManPDBVentas.frx":0ECA
      Caption         =   "frmManPDBVentas.frx":0FCC
      ...
      EndProperty
      DropDown        =   "frmManPDBVentas.frx":1030
      Keys            =   "frmManPDBVentas.frx":104E
      Spin            =   "frmManPDBVentas.frx":10BA
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   16777215
   ...
   Begin TDBNumber6Ctl.TDBNumber tdbnNumerico 
      ...
      _ExtentX        =   1931
      _ExtentY        =   423
      Calculator      =   "frmManPDBVentas.frx":10E2
      Caption         =   "frmManPDBVentas.frx":1102
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmManPDBVentas.frx":116E
      Keys            =   "frmManPDBVentas.frx":118C
      Spin            =   "frmManPDBVentas.frx":11D6
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   16777215
   ...
   Begin TrueOleDBGrid70.TDBGrid tdbgPDB 
      ...
      Columns(28).Caption=   "Indic. Percepciones"
      Columns(28).DataField=   ""
      Columns(28).DropDown=   "tdbdPercepciones"
      Columns(28).DropDown.vt=   8
      Columns(28)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(29)._VlistStyle=   0
      Columns(29)._MaxComboItems=   5
      Columns(29).Caption=   "Cod. Tasa Percep."
      Columns(29).DataField=   ""
      Columns(29).DropDown=   "tdbdPercepciones"
      ...
      Columns(30).Caption=   "Num. Const. Percep."
      ...
      Columns(31).Caption=   "Numero Doc Percepcion"
      ...
      Splits(0)._ColumnProps(41)=   "Column(8).Width=1164"
      Splits(0)._ColumnProps(42)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(43)=   "Column(8)._WidthInPix=1085"
      ...
      Splits(0)._ColumnProps(143)=   "Column(28).Width=1984"
      Splits(0)._ColumnProps(144)=   "Column(28).DividerColor=0"
      Splits(0)._ColumnProps(145)=   "Column(28)._WidthInPix=1905"
      ...
      Splits(0)._ColumnProps(160)=   "Column(31).Width=3122"
      Splits(0)._ColumnProps(161)=   "Column(31).DividerColor=0"
      Splits(0)._ColumnProps(162)=   "Column(31)._WidthInPix=3043"
   ...
   Begin TrueOleDBList70.TDBCombo tdbcMes 
      ...
      AddItemSeparator=   ";"
      _PropDict       =   $"frmManPDBVentas.frx":11FE
      _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
      _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
      _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
   ...
   Begin TrueOleDBList70.TDBCombo tdbcLibro 
      ...
      RowSubDividerColor=   12632256
      AddItemSeparator=   ";"
      _PropDict       =   $"frmManPDBVentas.frx":1285
      _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
      _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
      _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
      _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin MSForms.CommandButton cmdPreliminar 
      ...
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":130C
      FontHeight      =   165
      FontCharSet     =   0
   ...
   Begin MSForms.CommandButton cmdListar 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":18A6
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdEliminaItem 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":1E40
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdEliminarTodo 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":23DA
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdGrabar 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":2974
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdTodos 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":2F0E
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   ...
   Begin MSForms.CommandButton cmdSalir 
      ...
      PicturePosition =   327683
      Size            =   "2778;661"
      Picture         =   "frmManPDBVentas.frx":34A8
      FontHeight      =   165
      FontCharSet     =   0
      FontPitchAndFamily=   2
      ParagraphAlign  =   3
   End
End
Attribute VB_Name = "frmManPDBVentas"
...
Dim lrsPercep As New ADODB.Recordset
...
Private Sub CargaArregloDet(item As Integer)
    ...
    lArrDet(8) = NE(lArrDatos(item, 7 + i))
...
Private Sub cmdPreliminar_Click()
    ...
    AbreReporteParam gsDSN, Me, rutaReportes & "RptPDBVentas.rpt", crptToWindow, Titulo, "", matriz(), formulas()
    ...
    If lrsProvision.State <> 0 Then
        ...
        Do While Not lrsProvision.EOF
            ...
            Select Case cBaseImp
                Case "002": lArrDatos(Fila, 22 + i) = "1"
                Case "998", "999", "021": lArrDatos(Fila, 22 + i) = "2"
                Case Else: lArrDatos(Fila, 22 + i) = "3"
            End Select
            ...
            If cBaseImp = "021" Or cBaseImp = "999" Or cBaseImp = "998" Then
...
Private Sub CargaCombos()
    ...
    lrsTipoConVen.Fields("DESCRIPCION") = "VENTA INTERNA"
    lrsTipoConVen.AddNew
    lrsTipoConVen.Fields("CODIGO") = "02"
    lrsTipoConVen.Fields("DESCRIPCION") = "VENTA EXTERNA"
    ...
    '----------------------------------------------------------
    Set lrsPercep = fRetornaRS("select Tab_cCodSunat, Tab_cDescripCampo from tabla where emp_ccodigo='" & gsEmpresa & "' and tab_ctabla='092' ")
    Set tdbdPercepciones.DataSource = lrsPercep
    tdbdPercepciones.Columns(0).DataField = "Tab_cCodSunat"
    tdbdPercepciones.Columns(1).DataField = "Tab_cDescripCampo"
    '-----------------------------------------------------------
...
Private Sub Form_Load()
    ...
    sqlcombos = "SELECT LIB_CTIPOLIBRO, LIB_CDESCRIPCION FROM CNT_LIBRO_OPERA " & _
                "WHERE EMP_CCODIGO =  '" & gsEmpresa & "' AND Pan_cAnio = '" & gsAnio & "' and LIB_CTIPOLIBRO='" & lsLibroVen & "' " & _
...
Private Sub LlenaProvision()
    ...
    With frmBusCoa.tdbgProvisiones
        ...
        Dim cBaseImp  As String
        cBaseImp = CE(.Columns(33).Value) 'codigo de destino
        Select Case cBaseImp
            Case "002": lArrDatos(Fila, 22 + i) = "1"
            Case "998", "999", "021": lArrDatos(Fila, 22 + i) = "2"
            Case Else: lArrDatos(Fila, 22 + i) = "3"
...
Private Function ValidaPDBReglas() As Boolean
    ...
    For i = 0 To lArrDatos.Count(1) - 1
        If CE(lArrDatos(i, nCol_cNummov)) <> "" Then
            ...
            End If
            '---- Regla Campo N.02 ---------'
            cCadena = "01,03,05,06,07,08,12,15,16,23,25,34,35,36,37"
            ...
            cCadena = "01,03,07,08,12,34,35,36,37"
            ...
            End If
            '---- Regla Campo N.04 ---------'
            cCadena = "01,03,07,08,34,35,36,37"
            ...
            If CE(lArrDatos(i, nCol_cTipoComp)) = "12" And Len(CE(lArrDatos(i, nCol_cSerieComp))) <> 0 Then
                Mensajes "SERIE COMP. PAGO: So se debe ingresar la serie del documento para este tipo de documento"
                Exit Function
            End If
            
            If CE(lArrDatos(i, nCol_cTipoComp)) = "12" And Len(CE(lArrDatos(i, nCol_cSerieComp))) > 20 Then
                Mensajes "SERIE COMP. PAGO: So se debe ingresar la serie del documento de maximo 20 caracteres"
                Exit Function
            End If
            
            If CE(lArrDatos(i, nCol_cTipoComp)) <> "12" And Len(CE(lArrDatos(i, nCol_cSerieComp))) > 10 Then
                Mensajes "SERIE COMP. PAGO: So se debe ingresar la serie del documento de maximo 10 caracteres"
                Exit Function
            End If
            ...
            '---- Regla Campo N.08 ---------'
            If Not IsNumeric(lArrDatos(i, nCol_cNumDocPer)) And lArrDatos(i, nCol_cNumDocPer) <> "-" Then
                Mensajes "NUMERO DOC: Numero de documento debe ser numerico"
                Exit Function
            End If
            
            If Val(lArrDatos(i, nCol_cNumDocPer)) <= 0 And lArrDatos(i, nCol_cNumDocPer) <> "-" Then
                Mensajes "NUMERO DOC: Numero de documento debe ser mayor que cero"
                Exit Function
            End If
            
            If Len(CE(lArrDatos(i, nCol_cNumDocPer))) > 12 And lArrDatos(i, nCol_cNumDocPer) <> "-" Then
            ...
            If CE(lArrDatos(i, nCol_cCodDestino)) = "3" And NE(lArrDatos(i, nCol_cNumDestino)) > 2 Then
                Mensajes "NUMERO DESTINO: Numero de destino debe ser 1, 2"
                Exit Function
            End If
            ...
            If CE(lArrDatos(i, nCol_cIndDetra)) <> "0" And CE(lArrDatos(i, nCol_cIndDetra)) <> "1" Then
                Mensajes "INDICADOR PERCEPIONES: Ingrese indicador de percepciones valido 0 = Comp. pago no sujeto a detracciones, 1 = Sujeto a detracciones"
                Exit Function
            End If
            
            '---- Regla Campo N.22 ---------'
            If CE(lArrDatos(i, nCol_cIndDetra)) = "1" And CE(lArrDatos(i, nCol_cTasaDetra)) = "" Then
                Mensajes "CODIGO TASA PERCEPIONES: Ingrese la tasa de la percepcion"
                Exit Function
            End If
            
            If CE(lArrDatos(i, nCol_cIndDetra)) = "0" And CE(lArrDatos(i, nCol_cTasaDetra)) <> "" Then
                Mensajes "CODIGO TASA PERCEPIONES: La tasa de percepcion no debe de ingresarse"
                Exit Function
            End If
            ...
            If CE(lArrDatos(i, nCol_cIndDetra)) = "1" And CE(lArrDatos(i, nCol_cConsDetra)) = "" Then
                Mensajes "NUMERO CONST. PERCEPIONES: Ingrese el numero de serie del documento de percepcion"
                Exit Function
            End If
            
            '---- Regla Campo N.24 ---------'
            If CE(lArrDatos(i, nCol_cIndDetra)) = "1" And CE(lArrDatos(i, nCol_cIndReten)) = "" Then
                Mensajes "NUMERO CONST. PERCEPIONES: Ingrese el numero de serie del documento de percepcion"
                Exit Function
            End If
            ...
            If InStr(1, cCadena, CE(lArrDatos(i, nCol_cTipoComp))) = 1 And CE(lArrDatos(i, nCol_cTipoRef)) = "" Then
            ...
            cCadena2 = "01"
             ...
             If InStr(1, cCadena, CE(lArrDatos(i, nCol_cTipoComp))) = 1 And _
            ...
            If CE(lArrDatos(i, nCol_cTipo)) = "01" And InStr(1, cCadena, CE(lArrDatos(i, nCol_cTipoComp))) = 1 And _
               InStr(1, cCadena2, CE(lArrDatos(i, nCol_cTipoRef))) = 1 And Len(CE(lArrDatos(i, nCol_cSerieRef))) > 4 Then
                Mensajes "SERIE COMP. REF: Serie de referencia debe ser menor o igual a 4 digitos"
                Exit Function
            End If
            ...
            cCadena2 = "01"
             ...
             If InStr(1, cCadena, CE(lArrDatos(i, nCol_cTipoComp))) = 1 And _
               InStr(1, cCadena2, CE(lArrDatos(i, nCol_cTipoRef))) = 1 And CE(lArrDatos(i, nCol_cNumeroRef)) = "" Then
                Mensajes "NUMERO COMP. REF: Ingrese el numero de referencia"
                Exit Function
            End If
            
            If InStr(1, cCadena, CE(lArrDatos(i, nCol_cTipoComp))) = 1 And _
               InStr(1, cCadena2, CE(lArrDatos(i, nCol_cTipoRef))) = 1 And Len(CE(lArrDatos(i, nCol_cNumeroRef))) > 20 Then
                Mensajes "NUMERO COMP. REF: Numero de referencia debe ser menor o igual a 20 digitos"
                Exit Function
            End If
