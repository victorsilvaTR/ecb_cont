...
Begin VB.Form frmRepResumenCentrocosto 
   ...
   ClientTop       =   450
   ClientWidth     =   6210
   Icon            =   "frmRepResumenCentrocosto.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraTodo 
      ...
      Begin VB.Frame FraAGRUPADOPOR 
         ...
         Begin VB.OptionButton optCuenta 
            ...
            Width           =   2190
         End
         Begin VB.OptionButton optCCosto 
      ...
      Begin VB.Frame FraTIPODE 
         ...
         Begin VB.OptionButton optDelMes 
            ...
            Width           =   2145
         End
         Begin VB.OptionButton optAlmes 
            Caption         =   "Resumen al Mes"
            BeginProperty Font 
               Name            =   "Arial"
               Size            =   9
               Charset         =   0
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMes 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepResumenCentrocosto.frx":0ECA
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         RowSubDividerColor=   12632256
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepResumenCentrocosto.frx":0F51
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin MSForms.CommandButton cmdImprimir 
         ...
         Size            =   "2937;767"
         Picture         =   "frmRepResumenCentrocosto.frx":0FD8
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         PicturePosition =   327683
         Size            =   "2937;767"
         Picture         =   "frmRepResumenCentrocosto.frx":1572
         FontHeight      =   165
         FontCharSet     =   0
         FontPitchAndFamily=   2
         ParagraphAlign  =   3
   ...
   End
End
Attribute VB_Name = "frmRepResumenCentrocosto"
...
Private Sub cmdImprimir_Click()
    ...
    Dim matriz_fecha(6) As Variant
    Screen.MousePointer = vbHourglass
    ' ***
    If Me.optAlmes.Value = True Then
        matriz_fecha(0) = "@Tipo;RESUMEN_AL;True"
    Else
        matriz_fecha(0) = "@Tipo;RESUMEN_DEL;True"
    End If
    ...
    If Me.optCCosto.Value = True Then
        formulas(0) = "grupo = {spCn_RptCentroCostosResumen;1.Cos_cCodigo}"
    Else
        formulas(0) = "grupo = {spCn_RptCentroCostosResumen;1.Pla_cCuentaContable}"
    End If
    AbreReporteParam gsDSN, Me, rutaReportes & "RptCentroCostoResumen.rpt", crptToWindow, "Reporte por Cuentas y Centro de Costo", "", matriz_fecha(), formulas()
