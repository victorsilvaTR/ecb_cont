...
Begin VB.Form frmRepPresupuestoListado 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Listado de Presupuesto Anual"
   ClientHeight    =   2115
   ClientLeft      =   -15
   ClientTop       =   375
   ClientWidth     =   4800
   Icon            =   "frmRepPresupuestoListado.frx":0000
   LinkTopic       =   "form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   2115
   ScaleWidth      =   4800
   Begin VB.Frame fraTodo 
      ...
      Begin TrueOleDBList70.TDBCombo tdbcMoneda 
         ...
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepPresupuestoListado.frx":0ECA
      ...
      Begin MSForms.CommandButton cmdSalir 
         ...
         Size            =   "2937;767"
         Picture         =   "frmRepPresupuestoListado.frx":0F51
         FontHeight      =   165
         FontCharSet     =   0
   ...
   End
End
Attribute VB_Name = "frmRepPresupuestoListado"
...
Private Sub cmdImprimir_Click()
    ...
    matriz_fecha(2) = "@Per_cPeriodo;" & "" & ";True"
    If Me.optGastos.Value = True Then
        matriz_fecha(3) = "@Prm_cTipo;" & "G" & ";True"
    Else
        matriz_fecha(3) = "@Prm_cTipo;" & "I" & ";True"
    End If
    ...
    AbreReporteParam gsDSN, Me, rutaReportes & "RptPresupuestoListado.rpt", crptToWindow, "Listado de Presupuesto", "", matriz_fecha(), formulas()
